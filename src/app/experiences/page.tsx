...
export default function Experiences() {
    return (
        <div className="flex flex-col m-8 dark">
            <div>
                <h1 className="text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-cyan-400 text-4xl font-extrabold mb-5">Experiences</h1>
            ...
            <div>
                <h1 className="text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-cyan-400 text-4xl font-extrabold mb-5">Projects</h1>
                <div className="flex flex-wrap justify-center gap-8 mb-16">
